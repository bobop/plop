...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post divisions_url, params: { division: { name: @division.name, school_id: @division.school_id, slug: @division.slug } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { name: @division.name, school_id: @division.school_id, slug: @division.slug } }
