...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { name: @grade.name, school_id: @grade.school_id, slug: @grade.slug } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { name: @grade.name, school_id: @grade.school_id, slug: @grade.slug } }
